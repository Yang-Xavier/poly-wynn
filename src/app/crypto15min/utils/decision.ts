...
export const decideTailSweep = (
  ...
  const { ticks, intervalStartPrice, timeToExpiryMs, upBestAsk, downBestAsk } = input;
  ...
  if (upAsk !== null) {
    ...
    candidates.push({
      ...
      flipRisk,
      score,
      reason: passes ? "up_candidate_pass" : "up_candidate_fail_threshold",
    });
  }
  ...
  if (downAsk !== null) {
    ...
    candidates.push({
      ...
      flipRisk,
      score,
      reason: passes ? "down_candidate_pass" : "down_candidate_fail_threshold",
    });
  }
