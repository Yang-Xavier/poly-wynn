...
import { getChanceLogs, formatTradeLogForDisplay } from "../services/logService";
 ...
 */
export async function getChanceLogsHandler(
...
<head>
  ...
  <title>Chance 日志 - ${appName} - ${date || "今天"}</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    console.error("获取 Chance 日志失败:", error);
